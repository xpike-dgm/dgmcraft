...
def ciz(boya, tur, merkez, boyut, renk, kalinlik=1.7):
    ...
    if tur == "hub":
        ...
        cizgi(6.5, 21, 6.5, 3)
        yol([(6.5, 3.2), (19, 6.6), (6.5, 10.2)])
    elif tur == "tamam":
        daire(12, 12, 8.6)
        cizgi(7.8, 12.2, 10.8, 15.4, 16.4, 8.6)
    elif tur == "oyna":
        daire(12, 12, 8.6)
        yol([(9.8, 7.8), (16.2, 12), (9.8, 16.2)])
    elif tur == "kilit":
        yol([(7.6, 10.6), (7.6, 7.4), (12, 4.4), (16.4, 7.4), (16.4, 10.6)])
        kutu(5.4, 10.6, 18.6, 20, 2.2)
    elif tur == "kitap":
        ...
        daire(10.4, 10.4, 6.2)
        cizgi(15, 15, 20.2, 20.2)
    elif tur == "yukari":
        cizgi(6, 14.5, 12, 8, 18, 14.5)
    elif tur == "asagi":
        cizgi(6, 9.5, 12, 16, 18, 9.5)
    elif tur == "sagok":
        cizgi(9.5, 5, 16, 12, 9.5, 19)
    elif tur == "kutu":
        yol([(5, 5), (19, 5), (19, 19), (5, 19)])
    elif tur == "yildiz-dolu":
        yol([(12, 3), (14.3, 9.7), (21, 12), (14.3, 14.3), (12, 21),
             (9.7, 14.3), (3, 12), (9.7, 9.7)])
    elif tur == "nokta":
        daire(12, 12, 3.4, True)
    elif tur == "ayarlar":
        daire(12, 12, 3.2)
        daire(12, 12, 6.4)
